...
export namespace Prisma {
  ...
  */
  ...
  export type UnionCountOutputTypeGetPayload<
    S extends boolean | null | undefined | UnionCountOutputTypeArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends keyof UnionCountOutputType
          ? UnionCountOutputType[P]
          : never;
      }
    : UnionCountOutputType;
  ...
  export type UserGetPayload<S extends boolean | null | undefined | UserArgs> =
    S extends { select: any; include: any }
      ...
      ? User & {
          [P in TruthyKeys<S["include"]>]: P extends "union"
            ? UnionGetPayload<S["include"][P]> | null
      ...
      ? {
          [P in TruthyKeys<S["select"]>]: P extends "union"
            ? UnionGetPayload<S["select"][P]> | null
            : P extends "followedBy"
    ...
    implements Prisma.PrismaPromise<T>
  {
    ...
    union<T extends UnionArgs = {}>(
      args?: Subset<T, UnionArgs>
    ): Prisma__UnionClient<UnionGetPayload<T> | Null>;

    followedBy<T extends User$followedByArgs = {}>(
      args?: Subset<T, User$followedByArgs>
    ): Prisma.PrismaPromise<Array<UserGetPayload<T>> | Null>;

    following<T extends User$followingArgs = {}>(
      args?: Subset<T, User$followingArgs>
    ): Prisma.PrismaPromise<Array<UserGetPayload<T>> | Null>;
  ...
  type GetUnionGroupByPayload<T extends UnionGroupByArgs> =
    Prisma.PrismaPromise<
      Array<
  ...
  export type UnionGetPayload<
    S extends boolean | null | undefined | UnionArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ? Union
    ...
    ? Union & {
        [P in TruthyKeys<S["include"]>]: P extends "user"
          ? Array<UserGetPayload<S["include"][P]>>
          : P extends "_count"
          ? UnionCountOutputTypeGetPayload<S["include"][P]>
          : never;
      }
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends "user"
          ? Array<UserGetPayload<S["select"][P]>>
          : P extends "_count"
          ? UnionCountOutputTypeGetPayload<S["select"][P]>
          : P extends keyof Union
          ? Union[P]
          : never;
      }
    : Union;

  type UnionCountArgs = Omit<UnionFindManyArgs, "select" | "include"> & {
    select?: UnionCountAggregateInputType | true;
  };

  export interface UnionDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
    ...
    > extends True
      ...
      : Prisma__UnionClient<UnionGetPayload<T> | null, null>;
     ...
     * })
     **/
    aggregate<T extends UnionAggregateArgs>(
      args: Subset<T, UnionAggregateArgs>
    ): Prisma.PrismaPromise<GetUnionAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, UnionGroupByArgs, OrderByArg> & InputErrors
    ): {} extends InputErrors
      ? GetUnionGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__UnionClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
    ...
    user<T extends Union$userArgs = {}>(
      args?: Subset<T, Union$userArgs>
    ): Prisma.PrismaPromise<Array<UserGetPayload<T>> | Null>;
  ...
  type GetZerosumGroupByPayload<T extends ZerosumGroupByArgs> =
    Prisma.PrismaPromise<
      Array<
  ...
  export type ZerosumGetPayload<
    S extends boolean | null | undefined | ZerosumArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ? Zerosum
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends keyof Zerosum
          ? Zerosum[P]
          : never;
      }
    : Zerosum;

  type ZerosumCountArgs = Omit<ZerosumFindManyArgs, "select" | "include"> & {
    select?: ZerosumCountAggregateInputType | true;
  };

  export interface ZerosumDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends ZerosumFindUniqueArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
    ...
    > extends True
      ...
      : Prisma__ZerosumClient<ZerosumGetPayload<T> | null, null>;
     ...
     **/
    findFirst<
      T extends ZerosumFindFirstArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
     ...
     * })
     **/
    aggregate<T extends ZerosumAggregateArgs>(
      args: Subset<T, ZerosumAggregateArgs>
    ): Prisma.PrismaPromise<GetZerosumAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, ZerosumGroupByArgs, OrderByArg> & InputErrors
    ): {} extends InputErrors
      ? GetZerosumGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__ZerosumClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
  ...
  export type GetTrasferTransactionAggregateType<
    T extends TrasferTransactionAggregateArgs
  > = {
    [P in keyof T & keyof AggregateTrasferTransaction]: P extends
      | "_count"
      | "count"
      ? T[P] extends true
        ? number
  ...
  type GetTrasferTransactionGroupByPayload<
    T extends TrasferTransactionGroupByArgs
  > = Prisma.PrismaPromise<
    Array<
      PickArray<TrasferTransactionGroupByOutputType, T["by"]> & {
        [P in keyof T &
          keyof TrasferTransactionGroupByOutputType]: P extends "_count"
          ? T[P] extends boolean
            ? number
  ...
  export type TrasferTransactionGetPayload<
    S extends boolean | null | undefined | TrasferTransactionArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ? TrasferTransaction
    ...
    ? never
    : S extends { include: any } & (
        | TrasferTransactionArgs
        | TrasferTransactionFindManyArgs
      )
    ? TrasferTransaction
    : S extends { select: any } & (
        | TrasferTransactionArgs
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends keyof TrasferTransaction
          ? TrasferTransaction[P]
          : never;
      }
    : TrasferTransaction;

  type TrasferTransactionCountArgs = Omit<
    TrasferTransactionFindManyArgs,
    "select" | "include"
  > & {
  ...
  export interface TrasferTransactionDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends TrasferTransactionFindUniqueArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
    ...
    > extends True
      ...
      : Prisma__TrasferTransactionClient<
          TrasferTransactionGetPayload<T> | null,
          null
        >;
     ...
     **/
    findFirst<
      T extends TrasferTransactionFindFirstArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
    ...
    count<T extends TrasferTransactionCountArgs>(
      ...
      T extends _Record<"select", any>
        ? T["select"] extends true
          ...
          : GetScalarType<
              T["select"],
              TrasferTransactionCountAggregateOutputType
            >
        : number
    >;
     ...
     * })
     **/
    aggregate<T extends TrasferTransactionAggregateArgs>(
      args: Subset<T, TrasferTransactionAggregateArgs>
    ): Prisma.PrismaPromise<GetTrasferTransactionAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, TrasferTransactionGroupByArgs, OrderByArg> &
        InputErrors
    ): {} extends InputErrors
      ? GetTrasferTransactionGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__TrasferTransactionClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
   ...
   */
  export interface TrasferTransactionFindUniqueArgs
    extends TrasferTransactionFindUniqueArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
     */
   ...
   */
  export interface TrasferTransactionFindFirstArgs
    extends TrasferTransactionFindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
     */
  ...
  export type TrasferTransactionCreateArgs = {
     ...
     */
    data: XOR<
      TrasferTransactionCreateInput,
      TrasferTransactionUncheckedCreateInput
    >;
  };
  ...
  export type TrasferTransactionUpdateArgs = {
     ...
     */
    data: XOR<
      TrasferTransactionUpdateInput,
      TrasferTransactionUncheckedUpdateInput
    >;
    /**
  ...
  export type TrasferTransactionUpdateManyArgs = {
     ...
     */
    data: XOR<
      TrasferTransactionUpdateManyMutationInput,
      TrasferTransactionUncheckedUpdateManyInput
    >;
    /**
  ...
  export type GetDonationTransactionAggregateType<
    T extends DonationTransactionAggregateArgs
  > = {
    [P in keyof T & keyof AggregateDonationTransaction]: P extends
      | "_count"
      | "count"
      ? T[P] extends true
        ? number
  ...
  type GetDonationTransactionGroupByPayload<
    T extends DonationTransactionGroupByArgs
  > = Prisma.PrismaPromise<
    Array<
      PickArray<DonationTransactionGroupByOutputType, T["by"]> & {
        [P in keyof T &
          keyof DonationTransactionGroupByOutputType]: P extends "_count"
          ? T[P] extends boolean
            ? number
  ...
  export type DonationTransactionGetPayload<
    S extends boolean | null | undefined | DonationTransactionArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ? DonationTransaction
    ...
    ? never
    : S extends { include: any } & (
        | DonationTransactionArgs
        | DonationTransactionFindManyArgs
      )
    ? DonationTransaction
    : S extends { select: any } & (
        | DonationTransactionArgs
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends keyof DonationTransaction
          ? DonationTransaction[P]
          : never;
      }
    : DonationTransaction;

  type DonationTransactionCountArgs = Omit<
    DonationTransactionFindManyArgs,
    "select" | "include"
  > & {
  ...
  export interface DonationTransactionDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends DonationTransactionFindUniqueArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
    ...
    > extends True
      ...
      : Prisma__DonationTransactionClient<
          DonationTransactionGetPayload<T> | null,
          null
        >;
     ...
     **/
    findFirst<
      T extends DonationTransactionFindFirstArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
    ...
    count<T extends DonationTransactionCountArgs>(
      ...
      T extends _Record<"select", any>
        ? T["select"] extends true
          ...
          : GetScalarType<
              T["select"],
              DonationTransactionCountAggregateOutputType
            >
        : number
    >;
     ...
     * })
     **/
    aggregate<T extends DonationTransactionAggregateArgs>(
      args: Subset<T, DonationTransactionAggregateArgs>
    ): Prisma.PrismaPromise<GetDonationTransactionAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, DonationTransactionGroupByArgs, OrderByArg> &
        InputErrors
    ): {} extends InputErrors
      ? GetDonationTransactionGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__DonationTransactionClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
   ...
   */
  export interface DonationTransactionFindUniqueArgs
    extends DonationTransactionFindUniqueArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
     */
   ...
   */
  export interface DonationTransactionFindFirstArgs
    extends DonationTransactionFindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
     */
  ...
  export type DonationTransactionCreateArgs = {
     ...
     */
    data: XOR<
      DonationTransactionCreateInput,
      DonationTransactionUncheckedCreateInput
    >;
  };
  ...
  export type DonationTransactionUpdateArgs = {
     ...
     */
    data: XOR<
      DonationTransactionUpdateInput,
      DonationTransactionUncheckedUpdateInput
    >;
    /**
  ...
  export type DonationTransactionUpdateManyArgs = {
     ...
     */
    data: XOR<
      DonationTransactionUpdateManyMutationInput,
      DonationTransactionUncheckedUpdateManyInput
    >;
    /**
  ...
  export type GetRequestFriendTransactionAggregateType<
    T extends RequestFriendTransactionAggregateArgs
  > = {
    [P in keyof T & keyof AggregateRequestFriendTransaction]: P extends
      | "_count"
      | "count"
      ? T[P] extends true
        ? number
  ...
  type GetRequestFriendTransactionGroupByPayload<
    T extends RequestFriendTransactionGroupByArgs
  > = Prisma.PrismaPromise<
    Array<
      PickArray<RequestFriendTransactionGroupByOutputType, T["by"]> & {
        [P in keyof T &
          keyof RequestFriendTransactionGroupByOutputType]: P extends "_count"
          ? T[P] extends boolean
            ? number
  ...
  export type RequestFriendTransactionGetPayload<
    S extends boolean | null | undefined | RequestFriendTransactionArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ...
    ? never
    : S extends { include: any } & (
        | RequestFriendTransactionArgs
        | RequestFriendTransactionFindManyArgs
      )
    ? RequestFriendTransaction
    : S extends { select: any } & (
        | RequestFriendTransactionArgs
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends keyof RequestFriendTransaction
          ? RequestFriendTransaction[P]
          : never;
      }
    : RequestFriendTransaction;

  type RequestFriendTransactionCountArgs = Omit<
    RequestFriendTransactionFindManyArgs,
    "select" | "include"
  > & {
  ...
  export interface RequestFriendTransactionDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends RequestFriendTransactionFindUniqueArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
      ...
      "RequestFriendTransaction"
    > extends True
      ? Prisma__RequestFriendTransactionClient<
          RequestFriendTransactionGetPayload<T>
        >
      : Prisma__RequestFriendTransactionClient<
          RequestFriendTransactionGetPayload<T> | null,
          null
        >;
     ...
     **/
    findFirst<
      T extends RequestFriendTransactionFindFirstArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
        ? T["rejectOnNotFound"]
        : undefined
    >(
    ...
    count<T extends RequestFriendTransactionCountArgs>(
      ...
      T extends _Record<"select", any>
        ? T["select"] extends true
          ...
          : GetScalarType<
              T["select"],
              RequestFriendTransactionCountAggregateOutputType
            >
        : number
    >;
     ...
     * })
     **/
    aggregate<T extends RequestFriendTransactionAggregateArgs>(
      args: Subset<T, RequestFriendTransactionAggregateArgs>
    ): Prisma.PrismaPromise<GetRequestFriendTransactionAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<
        T,
        RequestFriendTransactionGroupByArgs,
        OrderByArg
      > &
        InputErrors
    ): {} extends InputErrors
      ? GetRequestFriendTransactionGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__RequestFriendTransactionClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
   ...
   */
  export interface RequestFriendTransactionFindUniqueArgs
    extends RequestFriendTransactionFindUniqueArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
     */
   ...
   */
  export interface RequestFriendTransactionFindFirstArgs
    extends RequestFriendTransactionFindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
     */
  ...
  export type RequestFriendTransactionCreateArgs = {
     ...
     */
    data: XOR<
      RequestFriendTransactionCreateInput,
      RequestFriendTransactionUncheckedCreateInput
    >;
  };
  ...
  export type RequestFriendTransactionUpdateArgs = {
     ...
     */
    data: XOR<
      RequestFriendTransactionUpdateInput,
      RequestFriendTransactionUncheckedUpdateInput
    >;
    /**
  ...
  export type RequestFriendTransactionUpdateManyArgs = {
     ...
     */
    data: XOR<
      RequestFriendTransactionUpdateManyMutationInput,
      RequestFriendTransactionUncheckedUpdateManyInput
    >;
    /**
  ...
  export type DonationTransactionScalarFieldEnum =
    typeof DonationTransactionScalarFieldEnum[keyof typeof DonationTransactionScalarFieldEnum];
  ...
  export type RequestFriendTransactionScalarFieldEnum =
    typeof RequestFriendTransactionScalarFieldEnum[keyof typeof RequestFriendTransactionScalarFieldEnum];
  ...
  export type TrasferTransactionScalarFieldEnum =
    typeof TrasferTransactionScalarFieldEnum[keyof typeof TrasferTransactionScalarFieldEnum];
  ...
  export type UnionScalarFieldEnum =
    typeof UnionScalarFieldEnum[keyof typeof UnionScalarFieldEnum];
  ...
  export type ZerosumScalarFieldEnum =
    typeof ZerosumScalarFieldEnum[keyof typeof ZerosumScalarFieldEnum];
  ...
  export type UnionCreateNestedOneWithoutUserInput = {
    create?: XOR<
      UnionCreateWithoutUserInput,
      UnionUncheckedCreateWithoutUserInput
    >;
  ...
  export type UserCreateNestedManyWithoutFollowingInput = {
    create?: XOR<
      Enumerable<UserCreateWithoutFollowingInput>,
      Enumerable<UserUncheckedCreateWithoutFollowingInput>
    >;
  ...
  export type UserCreateNestedManyWithoutFollowedByInput = {
    create?: XOR<
      Enumerable<UserCreateWithoutFollowedByInput>,
      Enumerable<UserUncheckedCreateWithoutFollowedByInput>
    >;
  ...
  export type UnionUpdateOneWithoutUserNestedInput = {
    ...
    connect?: UnionWhereUniqueInput;
    update?: XOR<
      UnionUpdateWithoutUserInput,
      UnionUncheckedUpdateWithoutUserInput
    >;
  };
  ...
  export type UserCreateNestedManyWithoutUnionInput = {
    create?: XOR<
      Enumerable<UserCreateWithoutUnionInput>,
      Enumerable<UserUncheckedCreateWithoutUnionInput>
    >;
  ...
  export type UserUpdateManyWithWhereWithoutFollowingInput = {
    ...
    data: XOR<
      ...
      UserUncheckedUpdateManyWithoutFollowedByInput
    >;
  };
  ...
  export type UserCreateOrConnectWithoutUnionInput = {
    where: UserWhereUniqueInput;
    create: XOR<
      UserCreateWithoutUnionInput,
      UserUncheckedCreateWithoutUnionInput
    >;
  };
  ...
  export type UserUpsertWithWhereUniqueWithoutUnionInput = {
    where: UserWhereUniqueInput;
    update: XOR<
      UserUpdateWithoutUnionInput,
      UserUncheckedUpdateWithoutUnionInput
    >;
    create: XOR<
      UserCreateWithoutUnionInput,
      UserUncheckedCreateWithoutUnionInput
